...
5. A company wants to reduce the physical computing footprint that developers use to run code. Which service would meet that need by enabling serverless architectures?
